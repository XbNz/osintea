...
final class Ipv4MmdbUpdater implements UpdaterInterface
{
    ...
    public function update(): void
    {
        ...
        $temporaryIpv4Mmdb = $temporaryDir->path('asn-ipv4.mmdb');
            ...
            RequestOptions::PROGRESS => function (int $totalBytes, int $downloadedBytes): void {
                ...
                $this->dispatcher->dispatch(
                    new UpdateProgressReportEvent(
                        UpdatableDatabase::RouteViewsAsnMmdbIpv4,
                        $totalBytes,
                        $downloadedBytes,
                    ),
                );
        ...
        $this->filesystem->move($temporaryIpv4Mmdb, $this->config->get('routeviews-integration.asn_mmdb.ipv4'));
    }

    public function supports(UpdatableDatabase $database): bool
    {
        return $database === UpdatableDatabase::RouteViewsAsnMmdbIpv4;
    }
}
